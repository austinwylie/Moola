...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
         ...
         */
        boolean canDismiss(Object token, float x, float y);
        ...
        void onClick(View view, Object token, float x, float y);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mCallbacks.canDismiss(mToken, motionEvent.getX(), motionEvent.getY())) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss) {
                    ...
                    mCallbacks.onClick(mView, mToken, mDownX, mDownY);
                }
